...
def get_backend(backend):
    if backend == "pytorch":
        from backend.backend_pytorch import BackendPytorch
        backend = BackendPytorch()
    elif backend == "pytorch-native":
        from backend.backend_pytorch_native import BackendPytorchNative
        backend = BackendPytorchNative()      
    elif backend == "onnxruntime":
        from backend.backend_onnxruntime import BackendOnnxruntime
